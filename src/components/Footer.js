...
export default function Footer() {
  ...
  return (
	...
	<div onClick={() => handleRedirect("/booking")} style={{ width: "30%",marginRight:10, height: 40, display: "flex", justifyContent: "center", alignContent: "center",marginTop:5,display:"flex",alignItems:"center",backgroundColor:"#1CC09E",borderRadius:5,color:"white"}}>
		Booking	
	</div>
